...
class Evaluator:
    ...
    def evaluate_save_and_plot_raw(self, act, steps, r_exp, step_exp, log_tuple) -> tuple[bool, bool]:
    ...
    def evaluate_save_and_plot_reevaluate(self, act, steps, r_exp, log_tuple) -> tuple[bool, bool]:
...
def get_cumulative_returns_and_step(env, act) -> tuple[float, int]:  # [ElegantRL.2022.03.03]
    """Usage
    eval_times = 4
    net_dim = 2 ** 7
