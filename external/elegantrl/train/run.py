...
from external.elegantrl.train.config import build_env
from external.elegantrl.train.evaluator import Evaluator
from external.elegantrl.train.replay_buffer import ReplayBuffer
...
def init_buffer(args, gpu_id: int) -> list[ReplayBuffer]:
